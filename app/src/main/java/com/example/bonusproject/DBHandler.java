...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + TB_NAME + "(" + KEY_ID + " INTEGER PRIMARY KEY,"
                + KEY_NAMA + " TEXT," + KEY_PASSWORD + " TEXT" + ")";
    ...
    public ArrayList getlistALL(){
        ...
        if (c.moveToFirst()){
            do {
//                DataModel u = new DataModel(Integer.parseInt(KEY_ID),KEY_NAMA,KEY_PASSWORD);
//                u.setId(Integer.parseInt(c.getString(0)));
//                u.setNama(c.getString(1));
//                u.setPassword(c.getString(2));
//                userList.add(u);
                userList.add("\n"+ c.getString(0) + "\t NAME: " +c.getString(1)+"\t PASSWORD: "+c.getString(2));
            }
            while (c.moveToNext());
        };
